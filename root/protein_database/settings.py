"""
Django settings for protein_database project.
...
INSTALLED_APPS = [
    ...
    'protein_design', #Django app for protein design
    'import_export',
    'django_filters',
    'widget_tweaks',
    'tailwind',
...
ROOT_URLCONF = 'protein_database.urls'
...
WSGI_APPLICATION = 'protein_database.wsgi.application'
